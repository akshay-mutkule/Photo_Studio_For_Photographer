...
export default function ExtraFeatures({ theme }: { theme: "dark" | "light" }) {
  ...
  const instagramPosts = [
    { id: 1, url: "https://images.unsplash.com/photo-1519741497674-611481863552?auto=format&fit=crop&w=1200&q=80", likes: 245, comments: 18 },
    { id: 2, url: "https://images.unsplash.com/photo-1583939003579-730e3918a45a?auto=format&fit=crop&w=1200&q=80", likes: 189, comments: 12 },
    { id: 3, url: "https://images.unsplash.com/photo-1522673607200-164d1b6ce486?auto=format&fit=crop&w=1200&q=80", likes: 312, comments: 24 },
    { id: 4, url: "https://images.unsplash.com/photo-1515934751635-c81c6bc9a2d8?auto=format&fit=crop&w=1200&q=80", likes: 421, comments: 35 }
  ];
